  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="glyphicon glyphicon-copy"></i> <span>PO</span>
        ...
        <li><a href="index.php?hal=espo"><i class="glyphicon glyphicon-plus"></i> <span>Buat Salinan PO</span></a></li>
          </ul>
        </li>
