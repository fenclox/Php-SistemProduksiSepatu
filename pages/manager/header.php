      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?hal=lappgw"><i class="glyphicon glyphicon-user"></i> Pegawai</a></li>
            <li><a href="index.php?hal=lapdo"><i class="glyphicon glyphicon-share"></i> Delivery Order</a></li>
          </ul>
        </li>
